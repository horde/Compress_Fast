 ...
 * @package   Compress_Fast
 */
abstract class BaseDriver implements CompressFastDriver
{
    /**
     ...
     */
    abstract public function compress(string $text): string;
     ...
     * @throws CompressFastException
     */
    abstract public function decompress(string $text): string;
}
